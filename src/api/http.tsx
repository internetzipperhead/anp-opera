...
export default {
  get(url: string, data = {}, options: MethodOptions = {}) {
    let config = {
      params: data,
  ...
  post(url: string, data = {}, options: MethodOptions = {}) {
  ...
  put(url: string, data = {}, options: MethodOptions = {}) {
    let contentType = CONTENT_TYPE_JSON
  ...
  delete(url: string, data = {}, options: MethodOptions = {}) {
    let contentType = CONTENT_TYPE_JSON
    if (options.contentType === 'form') {
      contentType = CONTENT_TYPE_FORM
      data = qs.stringify(data)
